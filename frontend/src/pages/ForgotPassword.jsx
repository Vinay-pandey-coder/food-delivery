        ...
        <div className='flex items-center w-full justify-center min-h-screen p-4 bg-[#fff9f6]'>
            <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8'>
                <div className='flex items-center gap-4 mb-4'>
                    <IoIosArrowRoundBack className='text-[#ff4d2d] cursor-pointer' onClick={()=>navigate('/login')} size={30} />
            ...
            />
                ...
                {step === 2 && 
                    ...
                    >
                        ...
                        <button onClick={handelVerifyOtp}
                            className={`w-full font-semibold py-2 rounded-lg transition duration-200 cursor-pointer bg-[#ff4d2d] text-white hover:bg-[#e64323]`}
                        >
                            Verify Otp
                        </button>
                ...
                {step === 3 && 
                    ...
                    <div className="mb-4">
                        ...
                        <button onClick={handelResetPassword}
                            className={`w-full font-semibold py-2 rounded-lg transition duration-200 cursor-pointer bg-[#ff4d2d] text-white hover:bg-[#e64323]`}
                        >
                            Reset Password
                        </button>
